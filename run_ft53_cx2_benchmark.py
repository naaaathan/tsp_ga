...
PAPER_CX2 = {'best': 10987, 'worst': 13055, 'average': 12243}
OPTIMAL_VALUE = 6905
...
def phase2_combinations(fitness_calc, phase1_results):
    ...
    configs = [
        ...
        {
            'name': 'High Gen (Gen=1500, Elite=10)',
            'population_size': 200,
        ...
        {
            'name': 'Large Pop (Pop=400, Gen=1000)',
            'population_size': 400,
            'max_generations': 1000,
            'crossover_probability': 0.80,
            'mutation_probability': 0.10,
        ...
        {
            'name': 'Max Resources (Pop=500, Gen=2500)',
            'population_size': 500,
...
def main():
    ...
    print("=" * 80)
    print("BENCHMARK FT53 - CX2 ONLY (3 FASES)")
    print("=" * 80)
    ...
    filepath = output_dir / f"ft53_cx2_benchmark_{output_data['timestamp']}.json"
    with open(filepath, 'w') as f:
        json.dump(output_data, f, indent=2)

    latest_path = output_dir / "ft53_cx2_benchmark_latest.json"
